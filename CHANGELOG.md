...
- Added TypeScript golden fixtures, shorthand-reference and constructor coverage, Base → abstract Mid → concrete Child relationship coverage, effective-export and outside-root diagnostic regressions, false-positive, project-selection, security, limit, read-only, CLI/library parity, and installed-artifact smoke tests.
