...
- Added deterministic TypeScript project selection, fixed no-config fallback behavior, path-alias support, ambiguity diagnostics, normalized kinds, exported variable/binding state, variable-bound class-expression relationships, POSIX paths, UTF-16 ranges, and SHA-256 symbol identities.
